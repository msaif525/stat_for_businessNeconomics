...
| Employee | Before | After | Difference, $d=\mathrm {After-Before}$ |
|:--------:|:------:|:-----:|:--------------------------------------:|
|    1     |  255   |  197  |                  -58                   |
|    2     |  230   |  225  |                   -5                   |
|    3     |  290   |  215  |                  -75                   |
...
$$t_0=\frac{\bar d-D_0}{s_D/\sqrt n}=\frac{-28.09-0}{25.81/\sqrt 11}=-3.609$$
...
Since $t_0$ falls in CR ($t_0<-t_{\alpha/2}$), so reject $H_0$.
